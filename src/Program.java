...
public class Program
{
    public static void main(String[] args)
    {
        ...
        Human man = new Human("Janusz", "Biedronka", new Double(35), new Integer(00000000000), new Animal("Doggy", "TheDog", new BigDecimal(4), new File("")), new Phone(123456789, "T-Mobile", 48), new Double(3000.5), new Car("Kombi", "Opel", "GD 12345", new BigDecimal(827362.4), 5));
